...
const dashboard = reactive({
	...
	sales_weight: 0,
	purchase_weight: 0,
	stock: { qty: 0, purchase_value: 0, sells_value: 0 },
	...
	return [
		{
			...
			items: [
				...
				{
					key: 'sales_due',
					label: __('Customer Due Receivable Amount'),
				...
				{
					key: 'sales_discount',
					label: __('Total Sales Discount'),
					value: formatAmount(dashboard.sales.discount),
		...
		},
		{
			...
			items: [
				...
				{
					key: 'purchase_due',
					label: __('Supplier Due Payable Amount'),
				...
				},
				{
					...
					label: __('Purchases Discount'),
					value: formatAmount(dashboard.purchase.discount),
					icon: 'mdi-tag-outline',
					color: 'pink',
				},
				{
			...
			items: [
				{
					...
					value: formatNumber(dashboard.stock.qty),
					hint: __('Current on-hand quantity'),
					icon: 'mdi-package-variant-closed',
					color: 'blue-grey',
				},
				{
					key: 'stock_purchase_value',
					label: __('Stock Purchase Value'),
					value: formatAmount(dashboard.stock.purchase_value),
					icon: 'mdi-currency-usd',
					color: 'brown',
				},
				{
					key: 'stock_sells_value',
					label: __('Current Stock Sells Value'),
					value: formatAmount(dashboard.stock.sells_value),
		...
		{
			key: 'finance',
			title: __('Finance & Profitability'),
			icon: 'mdi-bank-outline',
			items: [
				{
					key: 'gross_profit',
					label: __('Gross Profit'),
					value: formatAmount(dashboard.sales.total - dashboard.purchase.total),
					hint: __('Total Sales - Total Purchase'),
					icon: 'mdi-cash-plus',
					color: 'success',
				},
				{
					key: 'net_profit',
					label: __('Net Profit'),
					value: formatAmount(dashboard.sales.total - dashboard.purchase.total - dashboard.expenses.total),
					hint: __('Gross Profit - Total Expenses'),
					icon: 'mdi-cash-check',
					color: 'primary',
				},
				{
